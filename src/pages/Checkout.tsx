            ...
            <div className="md:col-span-2">
              ...
              {paymentMethod === "card" && (
                <Card className="bg-card border-none overflow-hidden">
                  ...
                  <CardContent>
                    <Form {...form}>
                      <form onSubmit={form.handleSubmit(handleCompletePayment)} className="space-y-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="1234 5678 9012 3456" className="bg-background" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input placeholder="MM/YY" className="bg-background" {...field} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input placeholder="123" className="bg-background" {...field} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                        ...
                        <Button type="submit" className="w-full mt-4">Complete Payment</Button>
                      </form>
                    </Form>
                  </CardContent>
                </Card>
                    ...
                    <div className="flex flex-col items-center justify-center py-6">
                      <div className="mb-4">
                        {paymentMethod === "ewallet" ? (
                          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-cinema-muted"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>
                        ) : (
                          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-cinema-muted"><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M12 12h.01"/><path d="M2 10h20"/></svg>
                        )}
                      </div>
                      ...
                      <Button onClick={handleCompletePayment} className="w-full">Continue to Payment</Button>
                    </div>
                  </CardContent>
                </Card>
              )}
